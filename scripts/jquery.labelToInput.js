 ...
 *    inputValue
 * @descripton
 *    Applied to an input element, this function takes the text value of the
 *    associated label element, hides that label, modifies the text if needed,
 *    and passes that text to jquery.inputValue.js                                   
 * @version
 *    1.0
 * @requires
 *    jQuery 1.2.6 +, jquery.inputValue.js
 * @author
 *    Christopher Torgalson <manager@bedlamhotel.com>
 * @license
 *    GPL 3
 * @param
 *    string p  Regex pattern for characters to replace in label; useful for
 *              removing colons etc. Default value restricts defaults to alpha-
